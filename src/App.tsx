...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900 flex flex-col font-['Plus_Jakarta_Sans',sans-serif] dark:bg-zinc-900 dark:text-zinc-50">
      ...
      <main className="max-w-7xl w-full mx-auto px-3 sm:px-6 py-4 sm:py-6 pb-28 sm:pb-12 space-y-5 sm:space-y-8 flex-1 overflow-x-hidden">
        ...
        <div className="lg:hidden flex items-center p-1 bg-zinc-100 rounded-2xl border border-zinc-200 shadow-2xs dark:bg-zinc-700 dark:border-zinc-800">
          <button
            type="button"
          ...
          >
            ...
            {tasks.length > 0 && (
              <span className="px-1.5 py-0.5 rounded-full text-[10px] bg-zinc-200 text-zinc-700 font-bold ml-0.5 dark:bg-zinc-600 dark:text-zinc-300">
                {tasks.length}
              </span>
            )}
          </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start w-full">
          ...
          >
            ...
            <div className="lg:hidden bg-white border border-zinc-200 rounded-2xl p-3.5 shadow-xs space-y-2.5 dark:bg-zinc-900 dark:border-zinc-800">
              <div className="flex items-center justify-between">
                <div>
                  <span className="text-[11px] font-bold uppercase text-zinc-400 tracking-wider block dark:text-zinc-500">
                    Selected Day
                  </span>
              ...
              {selectedDateTasks.length > 0 ? (
                <div className="space-y-1.5 pt-1 border-t border-zinc-100 dark:border-zinc-800">
                  {selectedDateTasks.map((t) => (
                    <div
                      ...
                      className="p-2 rounded-xl bg-zinc-50 border border-zinc-200/80 flex items-center justify-between gap-2 cursor-pointer hover:bg-zinc-100/70 dark:bg-zinc-800 dark:border-zinc-800/80 dark:hover:bg-zinc-700/70"
                    >
                      <div className="flex items-center gap-2 min-w-0">
                        ...
                        <span
                          className={`text-xs font-semibold truncate ${
                            t.completed ? 'line-through text-zinc-400 dark:text-zinc-500' : 'text-zinc-800 dark:text-zinc-200'
                          }`}
                        >
                          {t.title}
                        </span>
                      ...
                      <button
                        ...
                        className="text-[11px] font-bold text-sky-600 hover:text-sky-800 shrink-0 flex items-center gap-0.5 dark:text-sky-400 dark:hover:text-sky-300"
                      >
                        <span>Timer</span>
                ...
                <div className="text-[11px] text-zinc-400 pt-1 dark:text-zinc-500">
            ...
            <div className="bg-zinc-50 border border-zinc-200/80 rounded-2xl p-4 text-xs text-zinc-500 space-y-2 dark:bg-zinc-800 dark:border-zinc-800/80 dark:text-zinc-400">
