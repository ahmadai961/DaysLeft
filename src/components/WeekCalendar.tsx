...
export const WeekCalendar: React.FC<WeekCalendarProps> = ({
  ...
  return (
    <div className="bg-white border border-zinc-200 rounded-2xl shadow-xs overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-7 divide-y md:divide-y-0 md:divide-x divide-zinc-200 min-h-[auto] md:min-h-[380px]">
        {weekDays.map((dayItem) => {
          ...
          return (
            ...
            >
              {/* Day Header */}
              <div className="border-b border-zinc-100 pb-1.5 sm:pb-2 flex items-center justify-between">
                ...
                <button
                  ...
                  className="opacity-70 sm:opacity-0 group-hover:opacity-100 p-1 hover:bg-zinc-200 text-zinc-600 rounded-md transition-all cursor-pointer"
                  title="Add task"
                >
